...
!function (e, t) {
    ...
    function f(e, t, n) {
        let i = Array.from(e.attributes).filter(d).map(m), r = i.filter(e => "spread" === e.type)[0];
        if (r) {
            let e = c(r.expression, t.$data);
            i = i.concat(Object.entries(e).map(([e, t]) => m({name: e, value: t})))
        }
    ...
    function m({name: e, value: t}) {
        const n = p(e), i = n.match(u), r = n.match(/:([a-zA-Z0-9\-:]+)/), s = n.match(/\.[^.\]]+(?=[^\]]*$)/g) || [];
    ...
    function y(e, t, n, i = !1) {
        ...
        const r = f(e, n, "transition"), s = f(e, n, "show")[0];
        if (s && s.modifiers.includes("transition")) {
            ...
            n = i ? n.filter((e, t) => t < n.indexOf("out")) : n, function (e, t, n) {
                const i = {
                    ...
                    first: {opacity: 0, scale: x(t, "scale", 95)},
            ...
            const r = h(w((n.find(e => "enter" === e.value) || {expression: ""}).expression, e, t)),
                s = h(w((n.find(e => "enter-start" === e.value) || {expression: ""}).expression, e, t)),
                o = h(w((n.find(e => "enter-end" === e.value) || {expression: ""}).expression, e, t));
            E(e, r, s, o, i, () => {
            }, v)
        }(e, n, r, t) : t()
    }

    function g(e, t, n, i = !1) {
        if (i) return t();
        ...
        if (s && s.modifiers.includes("transition")) {
            ...
            n = i ? n.filter((e, t) => t > n.indexOf("out")) : n, function (e, t, n, i) {
                const r = {
                    ...
                    second: {opacity: 0, scale: x(t, "scale", 95)}
                };
                _(e, t, () => {
                }, i, r, b)
            }(e, n, i, t)
        } else r.some(e => ["leave", "leave-start", "leave-end"].includes(e.value)) ? function (e, t, n, i) {
            const r = h(w((n.find(e => "leave" === e.value) || {expression: ""}).expression, e, t)),
                s = h(w((n.find(e => "leave-start" === e.value) || {expression: ""}).expression, e, t)),
                o = h(w((n.find(e => "leave-end" === e.value) || {expression: ""}).expression, e, t));
            E(e, r, s, o, () => {
            }, i, b)
        }(e, n, r, t) : t()
    }
    ...
    function _(e, t, n, i, r, s) {
        ...
        const o = e.style.opacity, a = e.style.transform, l = e.style.transformOrigin,
            c = !t.includes("opacity") && !t.includes("scale"), u = c || t.includes("opacity"),
            d = c || t.includes("scale"), f = {
                start() {
    ...
    const w = (e, t, n) => "function" == typeof e ? n.evaluateReturnExpression(t, e) : e;

    function E(e, t, n, i, r, s, o) {
        e.__x_transition && (cancelAnimationFrame(e.__x_transition.nextFrame), e.__x_transition.callback && e.__x_transition.callback());
        const a = e.__x_original_classes || [], l = {
            start() {
                e.classList.add(...n)
            }, during() {
                e.classList.add(...t)
    ...
    function S(e, t, i, r, s) {
        o(t, "x-for");
        let a = $("function" == typeof i ? e.evaluateReturnExpression(t, i) : i), l = function (e, t, n, i) {
            let r = f(t, e, "if")[0];
            if (r && !e.evaluateReturnExpression(t, r.expression)) return [];
            let s = e.evaluateReturnExpression(t, n.items, i);
            k(s) && s > 0 && (s = Array.from(Array(s).keys(), e => e + 1));
            return s
        }(e, t, a, s), c = t;
        l.forEach((i, o) => {
            let u = function (e, t, i, r, s) {
                ...
                let r = f(t, e, "bind").filter(e => "key" === e.value)[0];
                return r ? e.evaluateReturnExpression(t, r.expression, () => i) : n
            }(e, t, o, u), m = function (e, t) {
                if (!e) return;
            ...
            m ? (delete m.__x_for_key, m.__x_for = u, e.updateElements(m, () => m.__x_for)) : (m = function (e, t) {
                let n = document.importNode(e.content, !0);
                return t.parentElement.insertBefore(n, t.nextElementSibling), t.nextElementSibling
            }(t, c), y(m, () => {
            }, e, r), m.__x_for = u, e.initializeElements(m, () => m.__x_for)), c = m, c.__x_for_key = d
        }), function (e, t) {
    ...
    function P(e, t, n, r, o, l, c) {
        ...
        if ("value" === n) {
            ...
            if (void 0 === u && r.match(/\./) && (u = ""), "radio" === t.type) void 0 === t.attributes.value && "bind" === l ? t.value = u : "bind" !== l && (t.checked = s(t.value, u)); else if ("checkbox" === t.type) "boolean" == typeof u || [null, void 0].includes(u) || "bind" !== l ? "bind" !== l && (Array.isArray(u) ? t.checked = u.some(e => s(e, t.value)) : t.checked = !!u) : t.value = String(u); else if ("SELECT" === t.tagName) !function (e, t) {
            ...
            Object.keys(u).sort((e, t) => u[e] - u[t]).forEach(e => {
                u[e] ? h(e).forEach(e => t.classList.add(e)) : h(e).forEach(e => t.classList.remove(e))
            })
        } else {
            const e = t.__x_original_classes || [], n = h(u);
    ...
    function D(e, t, n, i, r, s = {}) {
        ...
        if (i.includes("camel") && (n = a(n)), i.includes("away")) {
            let a = l => {
                t.contains(l.target) || t.offsetWidth < 1 && t.offsetHeight < 1 || (j(e, r, l, s), i.includes("once") && document.removeEventListener(n, a, o))
            };
            document.addEventListener(n, a, o)
        } else {
            let a = i.includes("window") ? window : i.includes("document") ? document : t, c = l => {
                if (a !== window && a !== document || document.body.contains(t)) {
                    if (!(function (e) {
                        ...
                        if (n = n.filter(e => !i.includes(e)), i.length > 0) {
                            if (i.filter(t => ("cmd" !== t && "super" !== t || (t = "meta"), e[t + "Key"])).length === i.length && n[0] === T(e.key)) return !1
                        }
                        return !0
                    }(l, i) || (i.includes("prevent") && l.preventDefault(), i.includes("stop") && l.stopPropagation(), i.includes("self") && l.target !== t))) {
                        j(e, r, l, s).then(e => {
                            !1 === e ? l.preventDefault() : i.includes("once") && a.removeEventListener(n, c, o)
                        })
                    }
                } else a.removeEventListener(n, c, o)
            };
    ...
    const {isArray: z} = Array, {getPrototypeOf: R, create: F, defineProperty: I, defineProperties: M, isExtensible: B, getOwnPropertyDescriptor: q, getOwnPropertyNames: U, getOwnPropertySymbols: W, preventExtensions: K, hasOwnProperty: G} = Object, {push: H, concat: V, map: Z} = Array.prototype;
    ...
    function ne(e, t, n) {
        V.call(U(n), W(n)).forEach(i => {
            let r = q(n, i);
            r.configurable || (r = fe(e, r, te)), I(t, i, r)
        }), K(t)
    }
    ...
    class ie {
        ...
        set(e, t, n) {
            ...
            return i[t] !== n ? (i[t] = n, r(i, t)) : "length" === t && z(i) && r(i, t), !0
        }
        ...
        ownKeys(e) {
            ...
            return V.call(U(t), W(t))
        }

        isExtensible(e) {
            const t = B(e);
            if (!t) return t;
            const {originalTarget: n, membrane: i} = this, r = B(n);
            return r || ne(i, e, n), r
        }
        ...
        getOwnPropertyDescriptor(e, t) {
            ...
            if (J(s)) return s;
            const o = q(e, t);
            return J(o) ? (s = fe(i, s, te), s.configurable || I(e, t, s), s) : o
        }

        preventExtensions(e) {
            const {originalTarget: t, membrane: n} = this;
            return ne(n, e, t), K(t), !0
        }

        defineProperty(e, t, n) {
            const {originalTarget: i, membrane: r} = this, {valueMutated: s} = r, {configurable: o} = n;
            if (G.call(n, "writable") && !G.call(n, "value")) {
                const e = q(i, t);
                n.value = e.value
            }
            return I(i, t, function (e) {
                return G.call(e, "value") && (e.value = ee(e.value)), e
            }(n)), !1 === o && I(e, t, fe(r, n, te)), s(i, t), !0
        }
    }
    ...
    class se {
        ...
        getOwnPropertyDescriptor(e, t) {
            ...
            if (J(s)) return s;
            const o = q(e, t);
            return J(o) ? (s = fe(i, s, re), G.call(s, "set") && (s.set = void 0), s.configurable || I(e, t, s), s) : o
        }
    ...
    function fe(e, t, n) {
        const {set: i, get: r} = t;
        return G.call(t, "value") ? t.value = n(e, t.value) : (J(r) || (t.get = function () {
            return n(e, r.call(ee(this)))
        }), J(i) || (t.set = function (t) {
    ...
    class me {
        constructor(e) {
            if (this.valueDistortion = de, this.valueMutated = ue, this.valueObserved = ce, this.valueIsObservable = le, this.objectGraph = new WeakMap, !J(e)) {
                const {valueDistortion: t, valueMutated: n, valueObserved: i, valueIsObservable: r} = e;
                this.valueDistortion = Q(t) ? t : de, this.valueMutated = Q(n) ? n : ue, this.valueObserved = Q(i) ? i : ce, this.valueIsObservable = Q(r) ? r : le
            }
        }

        getProxy(e) {
            const t = ee(e), n = this.valueDistortion(t);
        ...
        getReactiveState(e, t) {
            ...
            return i = {
                get reactive() {
                    const n = new ie(r, t), i = new Proxy(oe(t), n);
                    return Y(i, e), I(this, "reactive", {value: i}), i
                }, get readOnly() {
                    const n = new se(r, t), i = new Proxy(oe(t), n);
                    return Y(i, e), I(this, "readOnly", {value: i}), i
                }
            }, n.set(t, i), i
        }
    }
    ...
    class pe {
        constructor(e, t = null) {
            ...
            }), this.unobservedData = t ? t.getUnobservedData() : c(i, s);
        ...
        registerListeners(e, t) {
            f(e, this).forEach(({type: i, value: r, modifiers: s, expression: o}) => {
                switch (i) {
                    case"on":
                        D(this, e, r, s, o, t);
                        break;
                    case"model":
                        !function (e, t, i, r, s) {
                            ...
                            D(e, t, o, i, `${r} = rightSideOfExpression($event, ${r})`, () => n(n({}, s()), {}, {rightSideOfExpression: L(t, i, r)}))
                        }(this, e, s, o, t)
                }
            })
        }
                ...
                switch (r) {
                    ...
                    case"if":
                        ...
                        !function (e, t, n, i, r) {
                            ...
                            if (!n || s && !t.__x_transition) !n && s && g(t.nextElementSibling, () => {
                                t.nextElementSibling.remove()
                            }, e, i); else {
                                const n = document.importNode(t.content, !0);
                                t.parentElement.insertBefore(n, t.nextElementSibling), y(t.nextElementSibling, () => {
                                }, e, i), e.initializeElements(t.nextElementSibling, r), t.nextElementSibling.__x_inserted_me = !0
                            }
                        }(this, e, c, t, n);
                        break;
                    case"for":
        ...
        evaluateReturnExpression(e, t, i = (() => {
            ...
            return c(t, this.$data, n(n({}, i()), {}, {$dispatch: this.getDispatchFunction(e)}))
        }
        ...
        evaluateCommandExpression(e, t, i = (() => {
            ...
            return function (e, t, n = {}) {
                ...
                let i = Function;
                if (i = Object.getPrototypeOf((async function () {
                ...
                for (let t = 0; t < e.length; t++) {
                    ...
                    if (n && n.isSameNode(this.$el)) {
                        if ("attributes" === e[t].type && "x-data" === e[t].attributeName) {
                            const n = c(e[t].target.getAttribute("x-data") || "{}", {$el: this.$el});
